...
const HEADER_SYNONYMS: Record<ImportField, string[]> = {
  ...
  externalJobId: ["job id", "req id", "requisition", "requisition id", "external id", "external job id"],
  location: ["location", "city", "office"],
  workArrangement: ["arrangement", "work arrangement", "work type", "remote", "onsite", "remote/hybrid"],
