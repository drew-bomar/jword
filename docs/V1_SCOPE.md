...
- up to three boards per company, found automatically from saved application links and the public Greenhouse, Lever, and Ashby APIs, confirmed by the owner ([decision 019](decisions/019-board-discovery.md))
- configuration only: no job collection, storage, scheduling, or ranking of postings
...
- automatic job discovery or scraping (a company **watchlist** that records which public boards to monitor later was added in [decision 018](decisions/018-company-watchlist.md); decision 019 lets it look up whether boards exist; collecting or storing postings, scheduling, Leads, and ranking remain out of scope)
